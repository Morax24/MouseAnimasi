...
class PointerParticles extends HTMLElement {
    ...
    animateParticles() {
        ...
        // Add watermark "Moraxx" with Minecraft-like font
        this.ctx.font = "26px 'Press Start 2P', sans-serif"; // Reduced the font size
        ...
        const y = this.canvas.height - 40; // Slightly above the bottom
